...
@Component({
  selector: 'app-last-year-humidity',
  templateUrl: './last-year-humidity.component.html',
  styleUrls: ['./last-year-humidity.component.scss']
})
export class LastYearHumidityComponent {
  ...
  constructor(http: HttpClient, @Inject('BASE_URL') baseUrl: string) {
    ...
    http.get<DateMonthAverageValue[]>(baseUrl + 'Values/months-humidity-values/2020').subscribe(result => {
